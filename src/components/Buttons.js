        ...
        return (
            <div className="click-buttons">
                <div>
                    ...
                    <BuyClickButton className="wood-button" BuyClick={this.props.woodBuyClick} perClickPerUpg={wood.woodPerClickPerUpg} clickUpgCost={wood.woodClickUpgCost} />
                </div>
                <div>
                    ...
                    <BuyClickButton className="gold-button" BuyClick={this.props.goldBuyClick} perClickPerUpg={gold.goldPerClickPerUpg} clickUpgCost={gold.goldClickUpgCost} />
                </div>
                <div>
                    ...
                    <BuyClickButton className="food-button" BuyClick={this.props.foodBuyClick} perClickPerUpg={food.foodPerClickPerUpg} clickUpgCost={food.foodClickUpgCost} />
                </div>
            </div>
        );
    };
